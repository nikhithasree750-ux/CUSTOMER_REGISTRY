      ...
      <div className="flex items-center gap-3">
        ...
        <div className="relative">
          <button
            ...
            className="p-2 rounded-xl border border-slate-200 dark:border-slate-800 text-slate-650 dark:text-slate-350 hover:bg-slate-100 dark:hover:bg-slate-800 transition relative"
          >
            <Bell size={18} />
            {unreadCount > 0 && (
              <span className="absolute -top-1 -right-1 h-4 w-4 bg-indigo-650 text-indigo-150 flex items-center justify-center font-bold text-[9px] rounded-full ring-2 ring-white dark:ring-slate-900 animate-pulse">
                {unreadCount}
              </span>
            )}
          </button>
            ...
            <>
              ...
              <div className="absolute right-0 mt-2 w-80 bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-2xl shadow-2xl z-50 py-2 max-h-96 overflow-y-auto">
                ...
                <div className="divide-y divide-slate-50 dark:divide-slate-800/40">
                  {activities.length > 0 ? (
                    activities.map((act) => (
                      <div key={act.id} className="p-3.5 hover:bg-slate-50/50 dark:hover:bg-slate-800/30 text-[11px] text-slate-650 dark:text-slate-350 leading-relaxed font-medium">
                        <p>{act.text}</p>
            ...
            <>
              ...
              <div className="absolute right-0 mt-2 w-52 bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-xl shadow-xl z-50 py-1 transition duration-200">
                <div className="px-4 py-2 border-b border-slate-100 dark:border-slate-800">
                  ...
                  <p className="text-sm font-bold text-indigo-650 dark:text-indigo-400">{user?.role || 'Agent'}</p>
